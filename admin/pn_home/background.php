...
<div style="position:fixed; left:7.3%; top:45.3%;"> <a href="exam.php"> <img src="img/exam.png" width="16" height="16" onMouseOver="left_timeline_over()" onMouseOut="left_timeline_out()"> </a> </div>
<div style="position:fixed; left:9%; top:41.8%;"><a href="exam.php" style="text-decoration:none; color:#000;" id="timeline" onMouseOver="left_timeline_over()" onMouseOut="left_timeline_out()" ><h4>Exam Schedule</h4></a></div>


<div style="position:fixed; left:7.3%; top:49.3%;"> <a href="routine.php"> <img src="img/classr.png" width="16" height="16" onMouseOver="left_timeline_over()" onMouseOut="left_timeline_out()"> </a> </div>
<div style="position:fixed; left:9%; top:46%;"><a href="routine.php" style="text-decoration:none; color:#000;" id="timeline" onMouseOver="left_timeline_over()" onMouseOut="left_timeline_out()" ><h4>Class Routine</h4></a></div>

<div style="position:fixed; left:7%; top:53.7%;"> <a href="questions.php"> <img src="img/xmq.png" height="25" width="23" onMouseOver="left_users_over()" onMouseOut="left_users_out()"> </a> </div>
<div style="position:fixed; left:9%; top:50.7%;"><a href="questions.php" style="text-decoration:none; color:#000;" id="users" onMouseOver="left_users_over()" onMouseOut="left_users_out()"><h5>Previous Questions</h5></a></div>

<div style="position:fixed; left:7.3%; top:58.2%;"> <a href="feedback.php"> <img src="img/icon-feedback.png" height="25" width="23" onMouseOver="left_feedback_over()" onMouseOut="left_feedback_out()"> </a> </div>
<div style="position:fixed; left:9%; top:55%;"><a href="feedback.php" style="text-decoration:none; color:#000;" id="feedback" onMouseOver="left_feedback_over()" onMouseOut="left_feedback_out()"><h4>Feedback</h4></a></div>

<div style="position:fixed; left:7.2%; top:63.7%;"> <a href="Notice.php"> <img src="img/Notice.png" height="25" width="20" onMouseOver="left_notice_over()" onMouseOut="left_notice_out()"> </a> </div>
<div style="position:fixed; left:9%; top:60.7%;"><a href="Notice.php" style="text-decoration:none; color:#000;" id="notice" onMouseOver="left_notice_over()" onMouseOut="left_notice_out()"><h4>Notice</h4></a></div>

<div style="position:fixed; left:7%; top:68%;"> <a href="Settings.php"> <img src="img/settings2.png" height="25" width="23" onMouseOver="left_settings_over()" onMouseOut="left_settings_out()"> </a> </div>
<div style="position:fixed; left:9%; top:65%;"><a href="Settings.php" style="text-decoration:none; color:#000;" id="settings" onMouseOver="left_settings_over()" onMouseOut="left_settings_out()"><h4>Settings</h4></a></div>

<div style="position:fixed; left:7%; top:72.5%;"> <a href="users.php"> <img src="img/all_users.png" height="25" width="23" onMouseOver="left_users_over()" onMouseOut="left_users_out()"> </a> </div>
<div style="position:fixed; left:9%; top:69.5%;"><a href="users.php" style="text-decoration:none; color:#000;" id="users" onMouseOver="left_users_over()" onMouseOut="left_users_out()"><h4>All Users</h4></a></div>
...
<?php			
	 ...
	 while($online_data=mysql_fetch_array($query_online))
	 {
		...
		$online_user_Email=$fetch_online_user_info[10];
