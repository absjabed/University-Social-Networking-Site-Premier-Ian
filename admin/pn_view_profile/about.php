...
<?php
	...
	if(isset($_POST['basic_sub']))
	{
		if($_POST['day']=='Day:' && $_POST['month']=='Month:' && $_POST['year']=='Year:')
		{
			...
			mysql_query("update user_info set semester='$u_relationship' where user_id=$userid;");
		}
		else
		{
...
<div style="position:absolute;left:19%; top:169%; font-size:18px; color:#89919C;">Department </div>
<?php
	$user_dep_query=mysql_query("select * from users where user_id=$v_user_id");
	$user_dep=mysql_fetch_array($user_dep_query);
	$department=$user_dep[7];
	
	if($department=="CSE"){
		$department = "Computer Science & Engineering."
	
	?>
	<div style="position:absolute;left:27%;top:169.5%;"> <?php echo $department; ?> </div>
...
<div style="position:absolute;left:19%; top:175%; font-size:18px; color:#89919C;">Semester </div>
<?php
	$semesterp=$user_info_data[9];
	if($semesterp!="")
	{	
?>
		<div style="position:absolute;left:27%;top:175.5%;"> <?php echo $semesterp; ?> </div>
<?php
	}
	else
	{
?>
		<div style="position:absolute;left:27%;top:175.5%; color:#3B59A4; font-weight:bold;"> Add Semester </div>
<?php
	}
?>
...
<div style="position:absolute;left:19%; top:175%; font-size:18px; color:#89919C;">Current Semester: </div>


<div style="position:absolute;left:30%; top:175%;">
	<select name="relationship" style="font-size:15px;height:29;padding:3;">
	<option value=""> ------------ </option>
	
	<script type="text/javascript">
	
		var rel=new Array("1st","2nd","3rd","4th","5th","6th","7th","8th","ex-student");
...
<div style="position:absolute;left:53%;top:156%; font-size:18px; color:#89919C;"> Mobile Phones </div>
<div style="position:absolute;left:62%;top:155.4%;"> <input type="text" value="<?php echo $m_no; ?>" name="mno" style="height:33;width:150;font-size:16px;" maxlength="11"> </div>
