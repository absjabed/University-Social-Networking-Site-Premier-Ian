<?php
	...
	if(isset($_SESSION['tempfbuser']))
	{
		...
		$que1=mysql_query("select * from users where user_name='$user' ");
...
<select name="que" style="height:38;font-size:18px;padding:3;">
		...
		<option value="where did you meet you spouse?">where did you meet your best friend?</option>
		<option value="what is your oldest cousins name?">what is your oldest cousin's name?</option>
		<option value="what is your youngest childs nickname?">what is your youngest cousin's nickname?</option>
		<option value="what is your oldest childs nickname?">what is your oldest uncle's nickname?</option>
		...
		<option value="where did you spend you honeymoon?">where did you spend your childhood?</option>
</select>
</div>
