...
<!--Head background-->
<div style="position:fixed;left:0;top:0; height:6%; width:100%; z-index:2; background:yellowGreen">   </div>
<!--Head fb text-->
<div style="position:fixed;left:4.05%;top:0.8%;font-size:25;font-weight:900; z-index:3;"> <a href="../fb_home/Home.php" style="color:#FFFFFF; text-decoration:none;" onMouseOver="on_head_fb_text()" onMouseOut="out_head_fb_text()"> <font face="myFbFont"> Premier-ian </font> </a> </div>
...
<!--cover img-->
<div style="position:absolute; left:15.11%; top:6%;"> <img src="../../fb_users/<?php echo $v_gender; ?>/<?php echo $v_usrname; ?>/Cover/<?php echo $cover_img; ?>" height="279" width="943" onMouseOver="dis_cover_pic_edit();" onMouseOut="out_cover_pic_edit();" onClick="open_cover_photo()"> </div>
...
<img src="../../fb_users/<?php echo $v_gender; ?>/<?php echo $v_usrname; ?>/Cover/<?php echo $cover_img; ?>" style="height:500; width:800; ">
</div>
</div>
...
<div style="position:absolute; left:16.5%; top:33%; z-index:1;">
	<table border="0">
	<tr>
		<td>  <img src="../../fb_users/<?php echo $v_gender; ?>/<?php echo $v_usrname; ?>/Profile/<?php echo $profile_img; ?>" style="height:150; width:150;" onClick="open_profile_photo()">  </td>
...
<div style="position:fixed; background:#FFF; left:17%; top:5%; height:90%; width:65.5%; z-index:3"></div>
<div style="position:fixed; left:20%; top:10%;z-index:4;">
<img src="../../fb_users/<?php echo $v_gender; ?>/<?php echo $v_usrname; ?>/Profile/<?php echo $profile_img; ?>" style="height:500; width:800; ">
</div>
</div>
...
<?php
	 while($online_data=mysql_fetch_array($query_online))
	 {
		...
		$online_username=$fetch_online_user_info[10];
...
?>
			 <tr>
			   	   <td> <a href="view_profile.php?id=<?php echo $online_user_id; ?>"> <img src="../../fb_users/<?php echo $online_user_gender; ?>/<?php echo $online_username; ?>/Profile/<?php echo $online_user_pic; ?>" height="30" width="30"> </a> </td>
