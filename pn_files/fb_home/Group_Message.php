<?php
	...
	if(isset($_SESSION['fbuser']))
	{
		...
		$que_user_info=mysql_query("select * from users where user_name='$user_email'");
...
<body>
	...
	<div style="position:absolute; left:25.3%; top:32.5%;">
		<textarea style="height:100; width:550;" name="chat_txt" maxlength="511" placeholder="Chat with everyone here........."></textarea>
	</div>	
