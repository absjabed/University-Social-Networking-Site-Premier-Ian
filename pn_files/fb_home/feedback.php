<?php
	...
	if(isset($_SESSION['fbuser']))
	{
		...
		$usr_name=$_SESSION['fbuser'];
		$que_user_info=mysql_query("select * from users where user_name='$usr_name'");
...
#feedback_button
{
	...
	width:80;
	padding:2;
	background-color:yellowGreen; color:#FFFFFF;
	font-weight:bold;
}
</style>
<script>
...
<body>
	...
	<div style="position:absolute; left:25.3%; top:32.5%;">
		<textarea style="height:100; width:550;" name="feedback_txt" maxlength="100" placeholder="Give us a feedback :) ....."></textarea>
	</div>	
...
?>
	...
	<tr>
    	<td style="padding-left:25;" rowspan="2"> <img src="../../fb_users/<?php echo $user_gender; ?>/<?php echo $user_nam; ?>/Profile/<?php echo $user_pic; ?>" height="60" width="55">  </td>
