...
<head>
    ...
    <LINK REL="SHORTCUT ICON" HREF="../fb_title_icon/premierian.ico" />
</head>
<body>

<!--Head background-->
<div style="position:fixed;left:0;top:0; height:6%; width:100%; z-index:1; background:yellowGreen">   </div>
<!--Head fb text-->
<div style="position:fixed;left:4.05%;top:0.8%;font-size:25;font-weight:900; z-index:2;"> <a href="Home.php" style="color:#FFFFFF; text-decoration:none;" onMouseOver="on_head_fb_text()" onMouseOut="out_head_fb_text()"> <font face="myFbFont"> Premier-ian </font> </a> </div>
...
<?php
		...
		$query1=mysql_query("select * from users where user_name='$user'");
...
<div style="position:fixed; left:71.8%; top:0.6%; z-index:1;">
	...
	<tr id="hedarname2">
		...
		<td id="head_name_bg"> <a href="../fb_profile/Profile.php" id="head_name_font" style="color:white; font-size:12; font-weight:900;font-family:lucida Bright; text-transform:capitalize; text-decoration:none;"> &nbsp;  <?php echo $name; ?> &nbsp;</a> </td>
		<td style="color:purple;"> | </td>
		<td id="head_home_bg"> <a href="Home.php" id="head_home_font" style="color:white; font-size:12; font-weight:900;font-family:lucida Bright; text-decoration:none;"> &nbsp; Home &nbsp; </a> </td>
        <td style="color:purple;">|</td>
	</tr>
	</table>
</div>
...
<div style="position:fixed; left:9%; top:33%;"> <a href="Home.php" style="text-decoration:none; color:#000;" id="news_feed" onMouseOver="left_news_feed_over()" onMouseOut="left_news_feed_out()"> <h4>News_Feed</h4> </a></div>
...
<div style="position:fixed; left:7.3%; top:45.3%;"> <a href="../fb_profile/exam.php"> <img src="img/exam.png" width="16" height="16" onMouseOver="left_timeline_over()" onMouseOut="left_timeline_out()"> </a> </div>
<div style="position:fixed; left:9%; top:41.8%;"><a href="../fb_profile/exam.php" style="text-decoration:none; color:#000;" id="timeline" onMouseOver="left_timeline_over()" onMouseOut="left_timeline_out()" ><h4>Exam Schedule</h4></a></div>


<div style="position:fixed; left:7.3%; top:49.3%;"> <a href="../fb_profile/routine.php"> <img src="img/classr.png" width="16" height="16" onMouseOver="left_timeline_over()" onMouseOut="left_timeline_out()"> </a> </div>
<div style="position:fixed; left:9%; top:46%;"><a href="../fb_profile/routine.php" style="text-decoration:none; color:#000;" id="timeline" onMouseOver="left_timeline_over()" onMouseOut="left_timeline_out()" ><h4>Class Routine</h4></a></div>

<div style="position:fixed; left:7%; top:53.2%;"> <a href="../fb_profile/questions.php"> <img src="img/xmq.png" height="25" width="23" onMouseOver="left_users_over()" onMouseOut="left_users_out()"> </a> </div>
<div style="position:fixed; left:9%; top:50%;"><a href="../fb_profile/questions.php" style="text-decoration:none; color:#000;" id="users" onMouseOver="left_users_over()" onMouseOut="left_users_out()"><h5>Previous Questions</h5></a></div>

<div style="position:fixed; left:7.2%; top:57.6%;"><a href="../fb_profile/about.php"> <img src="img/about.png" onMouseOver="left_about_over()" onMouseOut="left_about_out()"> </a> </div>
<div style="position:fixed; left:9%; top:54.2%;"><a href="../fb_profile/about.php" style="text-decoration:none; color:#000;" id="about" onMouseOver="left_about_over()" onMouseOut="left_about_out()"><h4>About</h4></a></div>



<div style="position:fixed; left:7%; top:61.5%;"> <a href="../fb_profile/photos.php"> <img src="img/photo&video.PNG" onMouseOver="left_photos_over()" onMouseOut="left_photos_out()"> </a> </div>
<div style="position:fixed; left:9%; top:58.1%;"><a href="../fb_profile/photos.php" style="text-decoration:none; color:#000;" id="photos" onMouseOver="left_photos_over()" onMouseOut="left_photos_out()"><h4>Photos</h4></a></div>

<div style="position:fixed; left:7%; top:65.4%;"> <a href="Group_Message.php"> <img src="img/group.png" height="25" width="23" onMouseOver="left_group_message_over()" onMouseOut="left_group_message_out()"> </a> </div>
<div style="position:fixed; left:9%; top:62%;"><a href="Group_Message.php" style="text-decoration:none; color:#000;" id="group_message" onMouseOver="left_group_message_over()" onMouseOut="left_group_message_out()"><h4>Group Chat</h4></a></div>

<div style="position:fixed; left:7%; top:69.5%;"> <a href="Settings.php"> <img src="img/settings2.png" height="25" width="23" onMouseOver="left_settings_over()" onMouseOut="left_settings_out()"> </a> </div>
<div style="position:fixed; left:9%; top:67%;"><a href="Settings.php" style="text-decoration:none; color:#000;" id="settings" onMouseOver="left_settings_over()" onMouseOut="left_settings_out()"><h4>Settings</h4></a></div>
...
<?php			
	 ...
	 while($online_data=mysql_fetch_array($query_online))
	 {
		...
		$online_user = $fetch_online_user_info[10];
...
?>
			 <tr>
			   	   <td> <a href="../fb_view_profile/view_profile.php?id=<?php echo $online_user_id; ?>"> <img src="../../fb_users/<?php echo $online_user_gender; ?>/<?php echo $online_user; ?>/Profile/<?php echo $online_user_pic; ?>" height="30" width="30"> </a> </td>
