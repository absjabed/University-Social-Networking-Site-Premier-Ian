...
<div style="position:fixed;left:4%;top:1%; height:5%; width:8%; z-index:2; background:yellowGreen; display:none;" id="head_fb_text_backgraound">   </div>
...
<div style="position:fixed; left:71.8%; top:0.6%; z-index:2;">
	...
	<tr id="hedarname2">
		...
		<td style="padding-left:7;" id="head_img"> <a href="Profile.php">  <img src="../../fb_users/<?php echo $gender; ?>/<?php echo $user; ?>/Profile/<?php echo $img; ?>" style="height:27; width:25;"> </a> </td>
		
		<td id="head_name_bg"> <a href="Profile.php" id="head_name_font" style="color:white; font-size:12; font-weight:900;font-family:lucida Bright; text-transform:capitalize; text-decoration:none;"> &nbsp;  <?php echo $name; ?> &nbsp;</a> </td>
		<td style="color:purple;"> | </td>
		<td id="head_home_bg"> <a href="../fb_home/Home.php" id="head_home_font" style="color:white; font-size:12; font-weight:900;font-family:lucida Bright; text-decoration:none;"> &nbsp; Home &nbsp; </a> </td>
        <td style="color:purple;">|</td>
	</tr>
	</table>
</div>
