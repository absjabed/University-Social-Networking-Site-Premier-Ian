...
<div style="position:absolute;left:17%; top:139%; height:0.09%; width:66%; background:#CCC; z-index:1">
 ...
 <!--Basic Information--> 
 <?php
	$user_data_query=mysql_query("select * from users where user_name='$user'");
...
<div style="position:absolute;left:19%; top:169%; font-size:18px; color:#89919C;">Semester </div>
<?php
	$semesterp=$user_info_data[9];
	if($semesterp!="")
	{	
?>
		<div style="position:absolute;left:27%;top:169.5%;"> <?php echo $semesterp; ?> </div>
<?php
	}
	else
	{
?>
		<div style="position:absolute;left:27%;top:169.5%; color:#3B59A4; font-weight:bold;"> Add Semester </div>
<?php
	}
?>
...
<div style="position:absolute;left:19%; top:169%; font-size:18px; color:#89919C;">Current Semester: </div>


<div style="position:absolute;left:30%; top:169%;">
...
<div style="position:absolute;left:53%;top:156%; font-size:18px; color:#89919C;"> Mobile Phones </div>
<div style="position:absolute;left:62%;top:155.4%;"> <input type="text" value="<?php echo $m_no; ?>" name="mno" onKeyPress="return isNumberKey(event)" style="height:33;width:150;font-size:16px;" maxlength="11"> </div>
