...
if(isset($_POST['Login']))
{
	...
	$que1=mysql_query("select * from users where user_name='$user' and Password='$pass'");
	...
	if($count1>0)
	{
		...
		$que6=mysql_query("select * from users where user_name='$user'");
	...
	{
		$que5=mysql_query("select * from users where user_name='$user'");
